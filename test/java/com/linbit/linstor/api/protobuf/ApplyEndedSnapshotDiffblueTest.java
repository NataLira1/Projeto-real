...
public class ApplyEndedSnapshotDiffblueTest {
    /**
     * Test {@link ApplyEndedSnapshot#execute(InputStream)}.
     * <p>
     * Method under test: {@link ApplyEndedSnapshot#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyEndedSnapshot applyEndedSnapshot = new ApplyEndedSnapshot(new StltApiCallHandler(errorReporterRef, null,
        ...
        // Act
        applyEndedSnapshot.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplyEndedSnapshot#ApplyEndedSnapshot(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplyEndedSnapshot() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyEndedSnapshot.<init>(StltApiCallHandler).
        ...
        // Act
        ApplyEndedSnapshot actualApplyEndedSnapshot = new ApplyEndedSnapshot(apiCallHandlerRef);
