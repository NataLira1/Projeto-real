...
import com.linbit.linstor.proto.javainternal.c2s.IntStltRemoteOuterClass;
...
public class ApplyRemoteDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplyRemote#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyRemote applyRemote = new ApplyRemote(apiCallHandlerRef, new StderrErrorReporter("Module Name"));

        // Act
        applyRemote.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplyRemote#asS3RemotePojo(IntS3Remote, long, long)}.
     * <ul>
     *   <li>When DefaultInstance.</li>
     * </ul>
     * <p>
     * Method under test: {@link ApplyRemote#asS3RemotePojo(IntS3Remote, long, long)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testAsS3RemotePojo_whenDefaultInstance() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at com.linbit.linstor.api.protobuf.ApplyRemote.asS3RemotePojo(ApplyRemote.java:87)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        ApplyRemote.asS3RemotePojo(IntS3Remote.getDefaultInstance(), 1L, 1L);
    }

    /**
     * Test {@link ApplyRemote#asEbsRemotePojo(IntEbsRemote, long, long)}.
     * <ul>
     *   <li>When DefaultInstance.</li>
     * </ul>
     * <p>
     * Method under test: {@link ApplyRemote#asEbsRemotePojo(IntEbsRemote, long, long)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testAsEbsRemotePojo_whenDefaultInstance() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at java.base/java.util.UUID.fromString1(UUID.java:280)
        //       at java.base/java.util.UUID.fromString(UUID.java:258)
        //       at com.linbit.linstor.api.protobuf.ApplyRemote.asEbsRemotePojo(ApplyRemote.java:103)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        ApplyRemote.asEbsRemotePojo(IntEbsRemote.getDefaultInstance(), 1L, 1L);
    }

    /**
     * Test {@link ApplyRemote#asStltRemotePojo(IntStltRemote, long, long)}.
     * <ul>
     *   <li>When DefaultInstance.</li>
     * </ul>
     * <p>
     * Method under test: {@link ApplyRemote#asStltRemotePojo(IntStltRemote, long, long)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testAsStltRemotePojo_whenDefaultInstance() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at java.base/java.util.UUID.fromString1(UUID.java:280)
        //       at java.base/java.util.UUID.fromString(UUID.java:258)
        //       at com.linbit.linstor.api.protobuf.ApplyRemote.asStltRemotePojo(ApplyRemote.java:119)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        ApplyRemote.asStltRemotePojo(IntStltRemote.getDefaultInstance(), 1L, 1L);
    }

    /**
     * Test {@link ApplyRemote#ApplyRemote(StltApiCallHandler, ErrorReporter)}.
     * <p>
    ...
    public void testNewApplyRemote() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyRemote.<init>(StltApiCallHandler, ErrorReporter).
        ...
        // Act
        ApplyRemote actualApplyRemote = new ApplyRemote(apiCallHandlerRef, errorReporterRef);
