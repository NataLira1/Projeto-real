...
public class ApplyDeletedNodeDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplyDeletedNode#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyDeletedNode applyDeletedNode = new ApplyDeletedNode(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
        ...
        // Act
        applyDeletedNode.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplyDeletedNode#ApplyDeletedNode(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplyDeletedNode() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyDeletedNode.<init>(StltApiCallHandler).
