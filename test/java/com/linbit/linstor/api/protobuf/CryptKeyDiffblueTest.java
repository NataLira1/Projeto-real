...
public class CryptKeyDiffblueTest {
     ...
     * <p>
     * Method under test: {@link CryptKey#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        CryptKey cryptKey = new CryptKey(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
        ...
        // Act
        cryptKey.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link CryptKey#CryptKey(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewCryptKey() {
        ...
        //   com.linbit.linstor.api.protobuf.CryptKey.<init>(StltApiCallHandler).
        ...
        // Act
        CryptKey actualCryptKey = new CryptKey(apiCallHandlerRef);
