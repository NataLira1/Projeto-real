...
public class ApplyDeletedExternalFileDiffblueTest {
    /**
     * Test {@link ApplyDeletedExternalFile#execute(InputStream)}.
     * <p>
     * Method under test: {@link ApplyDeletedExternalFile#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyDeletedExternalFile applyDeletedExternalFile = new ApplyDeletedExternalFile(
                new StltApiCallHandler(errorReporterRef, null, stltCfgRef, controllerPeerConnectorRef, updateMonitorRef, null,
                        applicationLifecycleManagerRef, null, null, null, null, null, null, null, stltExtToolsCheckerRef,
                        interComSerializerRef, reconfigurationLockRef3, nodesMapLockRef3, rscDfnMapLockRef3, storPoolDfnMapLockRef2,
                        extFileMapLockRef, remoteMapLockRef, satellitePropsRef, null, null, null, null, stltSecObjRef, null,
                        eventBrokerRef, whiteListPropsReconfiguratorRef, null, drbdStateTrackerRef, drbdEventPublisherRef,
                        deviceProviderMapperRef, backupShippingMgrRef, stltApiCallHandlerUtilsRef, platformStltRef,
                        new StltMigrationHandler(null, errorReporterRef7, controllerPeerConnectorRef2, extCmdFactoryRef2,
                                new HashMap<>())));
    ...
    /**
     * Test {@link ApplyDeletedExternalFile#ApplyDeletedExternalFile(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplyDeletedExternalFile() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyDeletedExternalFile.<init>(StltApiCallHandler).
    ...
    /**
     * Test {@link ApplyDeletedExternalFile#asExternalFilePojo(String, long, long)}.
     * <p>
     * Method under test: {@link ApplyDeletedExternalFile#asExternalFilePojo(String, long, long)}
     */
    @Test
    public void testAsExternalFilePojo() {
        // Arrange and Act
        ExternalFilePojo actualAsExternalFilePojoResult = ApplyDeletedExternalFile.asExternalFilePojo("foo.txt", 1L, 1L);

        // Assert
        assertEquals("foo.txt", actualAsExternalFilePojoResult.getFileName());
        assertNull(actualAsExternalFilePojoResult.getContent());
        assertNull(actualAsExternalFilePojoResult.getContentChecksum());
        assertNull(actualAsExternalFilePojoResult.getUuid());
        assertEquals(0L, actualAsExternalFilePojoResult.getFlags());
        assertEquals(1L, actualAsExternalFilePojoResult.getFullSyncId().longValue());
        assertEquals(1L, actualAsExternalFilePojoResult.getUpdateId().longValue());
    }
}
