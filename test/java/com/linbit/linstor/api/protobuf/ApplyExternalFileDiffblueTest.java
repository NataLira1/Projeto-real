...
public class ApplyExternalFileDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplyExternalFile#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyExternalFile applyExternalFile = new ApplyExternalFile(new StltApiCallHandler(errorReporterRef, null,
        ...
        // Act
        applyExternalFile.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }
    ...
    public void testNewApplyExternalFile() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyExternalFile.<init>(StltApiCallHandler).
        ...
        // Act
        ApplyExternalFile actualApplyExternalFile = new ApplyExternalFile(apiCallHandlerRef);
