...
public class ApplyDeletedRscDiffblueTest {
    /**
     * Test {@link ApplyDeletedRsc#execute(InputStream)}.
     * <p>
     * Method under test: {@link ApplyDeletedRsc#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyDeletedRsc applyDeletedRsc = new ApplyDeletedRsc(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
    ...
    /**
     * Test {@link ApplyDeletedRsc#ApplyDeletedRsc(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplyDeletedRsc() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyDeletedRsc.<init>(StltApiCallHandler).
        ...
        // Act
        ApplyDeletedRsc actualApplyDeletedRsc = new ApplyDeletedRsc(apiCallHandlerRef);
