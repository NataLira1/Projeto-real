...
public class ApplyDeletedRemoteDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplyDeletedRemote#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyDeletedRemote applyDeletedRemote = new ApplyDeletedRemote(new StltApiCallHandler(errorReporterRef, null,
        ...
        // Act
        applyDeletedRemote.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplyDeletedRemote#ApplyDeletedRemote(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplyDeletedRemote() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyDeletedRemote.<init>(StltApiCallHandler).
        ...
        // Act
        ApplyDeletedRemote actualApplyDeletedRemote = new ApplyDeletedRemote(apiCallHandlerRef);
