...
public class ApplySnapshotDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplySnapshot#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplySnapshot applySnapshot = new ApplySnapshot(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
        ...
        // Act
        applySnapshot.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplySnapshot#asSnapshotPojo(IntSnapshot, long, long)}.
     * <ul>
     *   <li>When DefaultInstance.</li>
     * </ul>
     * <p>
     * Method under test: {@link ApplySnapshot#asSnapshotPojo(IntSnapshotOuterClass.IntSnapshot, long, long)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testAsSnapshotPojo_whenDefaultInstance() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   com.linbit.ImplementationError: Unexpected layer type in proto message: UNKNOWN_LAYER Layered rsc id: 0
        //       at com.linbit.linstor.api.protobuf.ProtoLayerUtils.extractRscLayerData(ProtoLayerUtils.java:278)
        //       at com.linbit.linstor.api.protobuf.ApplySnapshot.asSnapshotPojo(ApplySnapshot.java:84)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        ApplySnapshot.asSnapshotPojo(IntSnapshot.getDefaultInstance(), 1L, 1L);
    }

    /**
     * Test {@link ApplySnapshot#ApplySnapshot(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewApplySnapshot() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplySnapshot.<init>(StltApiCallHandler).
        ...
        // Act
        ApplySnapshot actualApplySnapshot = new ApplySnapshot(apiCallHandlerRef);
