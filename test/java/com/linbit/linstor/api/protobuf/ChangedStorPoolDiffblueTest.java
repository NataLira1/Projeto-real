...
public class ChangedStorPoolDiffblueTest {
    /**
     * Test {@link ChangedStorPool#executeReactive(InputStream)}.
     * <ul>
     *   <li>When {@link ByteArrayInputStream#ByteArrayInputStream(byte[])} with {@code AXAXAXAX} Bytes is {@code UTF-8}.</li>
     * </ul>
     * <p>
     * Method under test: {@link ChangedStorPool#executeReactive(InputStream)}
     */
    @Test
    ...
    public void testExecuteReactive_whenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8() throws IOException {
        ...
        //       at com.linbit.linstor.api.protobuf.ChangedStorPool.executeReactive(ChangedStorPool.java:45)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange
        ChangedStorPool changedStorPool = new ChangedStorPool(null,
                new ResponseSerializer(new ProtoCommonSerializer(new StderrErrorReporter("Module Name"), null)));

        // Act
        changedStorPool.executeReactive(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ChangedStorPool#ChangedStorPool(DeviceManager, ResponseSerializer)}.
     * <p>
     * Method under test: {@link ChangedStorPool#ChangedStorPool(DeviceManager, ResponseSerializer)}
     */
    @Test
    public void testNewChangedStorPool() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: Missing observers.
        //   Diffblue Cover was unable to create an assertion.
        //   Add getters for the following fields or make them package-private:
        //     ChangedStorPool.deviceManager
        //     ChangedStorPool.responseSerializer

        // Arrange and Act
        new ChangedStorPool(null,
                new ResponseSerializer(new ProtoCommonSerializer(new StderrErrorReporter("Module Name"), null)));
