...
public class ReqVlmAllocatedDiffblueTest {
    /**
     * Test {@link ReqVlmAllocated#executeReactive(InputStream)}.
     * <ul>
     *   <li>Then return Prefetch is minus one.</li>
     * </ul>
     * <p>
     * Method under test: {@link ReqVlmAllocated#executeReactive(InputStream)}
     */
    @Test
    public void testExecuteReactive_thenReturnPrefetchIsMinusOne() throws UnsupportedEncodingException {
        ...
        ReqVlmAllocated reqVlmAllocated = new ReqVlmAllocated(scopeRunnerRef, apiCallHandlerUtilsRef,
                new ProtoCommonSerializer(new StderrErrorReporter("Module Name"), null), null);

        // Act
        Flux<byte[]> actualExecuteReactiveResult = reqVlmAllocated
    ...
    /**
     * Test {@link ReqVlmAllocated#ReqVlmAllocated(ScopeRunner, StltApiCallHandlerUtils, CommonSerializer, Provider)}.
     * <p>
    ...
    public void testNewReqVlmAllocated() {
        ...
        //   com.linbit.linstor.api.protobuf.ReqVlmAllocated.<init>(ScopeRunner, StltApiCallHandlerUtils, CommonSerializer, Provider).
        ...
        // Act
        ReqVlmAllocated actualReqVlmAllocated = new ReqVlmAllocated(scopeRunnerRef, apiCallHandlerUtilsRef,
                commonSerializerRef, apiCallIdProviderRef);
