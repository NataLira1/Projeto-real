...
public class ReqErrorReportsDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ReqErrorReports#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ReqErrorReports reqErrorReports = new ReqErrorReports(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
        ...
        // Act
        reqErrorReports.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ReqErrorReports#ReqErrorReports(StltApiCallHandler, Provider)}.
     * <p>
    ...
    public void testNewReqErrorReports() {
        ...
        //   com.linbit.linstor.api.protobuf.ReqErrorReports.<init>(StltApiCallHandler, Provider).
        ...
        // Act
        ReqErrorReports actualReqErrorReports = new ReqErrorReports(apiCallHandlerRef, peerProviderRef);
