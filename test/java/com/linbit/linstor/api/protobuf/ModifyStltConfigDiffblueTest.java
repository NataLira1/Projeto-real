...
public class ModifyStltConfigDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ModifyStltConfig#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ModifyStltConfig modifyStltConfig = new ModifyStltConfig(apiCallHandlerRef,
                new ProtoCtrlStltSerializer(errReporter2, null, secObjsRef2, ReadOnlyPropsImpl.emptyRoProps()), null, null);

        // Act
        modifyStltConfig.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ModifyStltConfig#ModifyStltConfig(StltApiCallHandler, CtrlStltSerializer, Provider, Provider)}.
     * <p>
    ...
    public void testNewModifyStltConfig() {
        ...
        //   com.linbit.linstor.api.protobuf.ModifyStltConfig.<init>(StltApiCallHandler, CtrlStltSerializer, Provider, Provider).
        ...
        Provider<Long> apiCallIdRef = null;

        // Act
        ModifyStltConfig actualModifyStltConfig = new ModifyStltConfig(apiCallHandlerRef, interComSerializerRef,
                peerProviderRef, apiCallIdRef);
