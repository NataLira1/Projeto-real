...
import com.linbit.linstor.proto.javainternal.c2s.IntStorPoolOuterClass;
...
public class ApplyStorPoolDiffblueTest {
     ...
     * <p>
     * Method under test: {@link ApplyStorPool#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        ApplyStorPool applyStorPool = new ApplyStorPool(apiCallHandlerRef,
                new ControllerPeerConnectorImpl(null, reconfigurationLockRef6, nodesMapLockRef5, rscDfnMapLockRef5,
                        storPoolDfnMapLockRef3, errorReporterRef8, null, nodeFactoryRef2, null, commonSerializerRef3, null, null,
                        new StltExtToolsChecker(errorReporterRef9, drbdVersionCheckRef2, extCmdFactoryRef3, stltCfgRef3,
                                new DrbdEventService(null, new DrbdStateTracker(), null, null))));

        // Act
        applyStorPool.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link ApplyStorPool#asStorPoolPojo(IntStorPool, String, long, long)}.
     * <ul>
     *   <li>When DefaultInstance.</li>
     * </ul>
     * <p>
     * Method under test: {@link ApplyStorPool#asStorPoolPojo(IntStorPoolOuterClass.IntStorPool, String, long, long)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testAsStorPoolPojo_whenDefaultInstance() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        //       at com.linbit.linstor.api.protobuf.ApplyStorPool.asStorPoolPojo(ApplyStorPool.java:69)
        //   See https://diff.blue/R013 to resolve this issue.

        // Arrange and Act
        ApplyStorPool.asStorPoolPojo(IntStorPool.getDefaultInstance(), "Node Name", 1L, 1L);
    }

    /**
     * Test {@link ApplyStorPool#ApplyStorPool(StltApiCallHandler, ControllerPeerConnector)}.
     * <p>
    ...
    public void testNewApplyStorPool() {
        ...
        //   com.linbit.linstor.api.protobuf.ApplyStorPool.<init>(StltApiCallHandler, ControllerPeerConnector).
        ...
        // Act
        ApplyStorPool actualApplyStorPool = new ApplyStorPool(apiCallHandlerRef, controllerPeerConnectorRef);
