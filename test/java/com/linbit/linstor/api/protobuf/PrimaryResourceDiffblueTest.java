...
public class PrimaryResourceDiffblueTest {
     ...
     * <p>
     * Method under test: {@link PrimaryResource#execute(InputStream)}
     */
    @Test
    ...
    public void testExecute() throws StorageException, IOException {
        ...
        PrimaryResource primaryResource = new PrimaryResource(new StltApiCallHandler(errorReporterRef, null, stltCfgRef,
        ...
        // Act
        primaryResource.execute(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
    }

    /**
     * Test {@link PrimaryResource#PrimaryResource(StltApiCallHandler)}.
     * <p>
    ...
    public void testNewPrimaryResource() {
        ...
        //   com.linbit.linstor.api.protobuf.PrimaryResource.<init>(StltApiCallHandler).
        ...
        // Act
        PrimaryResource actualPrimaryResource = new PrimaryResource(apiCallHandlerRef);
