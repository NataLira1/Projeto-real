...
public class BackupShippingS3ServiceDiffblueTest {
    /**
     * Test {@link BackupShippingS3Service#getCommandReceiving(String, AbsRemote, AbsStorageVlmData)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#getCommandReceiving(String, AbsRemote, AbsStorageVlmData)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testGetCommandReceiving()
        ...
        BackupShippingS3Service backupShippingS3Service = new BackupShippingS3Service(backupHandlerRef, errorReporterRef,
        ...
        S3Remote ignoredRemote = new S3Remote(null, objIdRef, driverRef, remoteNameRef, 1L,
        ...
        // Act
        backupShippingS3Service.getCommandReceiving("Cmd Ref", ignoredRemote,
                new DisklessData<>(vlmRef, rscDataRef, 3L, null, dbDriverRef12, new TransactionObjectFactory(null), null));
    }

    /**
     * Test {@link BackupShippingS3Service#getCommandSending(String, AbsRemote, AbsStorageVlmData)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#getCommandSending(String, AbsRemote, AbsStorageVlmData)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testGetCommandSending()
            throws ValueOutOfRangeException, MdException, DatabaseException, UnsupportedEncodingException {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        ...
        // Act
        backupShippingS3Service.getCommandSending("Cmd Ref", ignoredRemote,
                new DisklessData<>(vlmRef, rscDataRef, 3L, null, dbDriverRef12, new TransactionObjectFactory(null), null));
    }

    /**
     * Test {@link BackupShippingS3Service#getBackupNameForRestore(AbsStorageVlmData)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#getBackupNameForRestore(AbsStorageVlmData)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testGetBackupNameForRestore()
        ...
        // Act
        backupShippingS3Service.getBackupNameForRestore(
                new DisklessData<>(vlmRef, rscDataRef, 3L, null, dbDriverRef12, new TransactionObjectFactory(null), null));
    }

    /**
     * Test {@link BackupShippingS3Service#createDaemon(AbsStorageVlmData, String[], String, AbsRemote, boolean, Integer, BiConsumer)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#createDaemon(AbsStorageVlmData, String[], String, AbsRemote, boolean, Integer, BiConsumer)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testCreateDaemon()
        ...
        // Act
        backupShippingS3Service.createDaemon(snapVlmDataRef, new String[]{"Full Command"}, "Backup Name Ref",
    ...
    /**
     * Test {@link BackupShippingS3Service#preCtrlNotifyBackupShipped(boolean, boolean, Snapshot, ShippingInfo)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#preCtrlNotifyBackupShipped(boolean, boolean, Snapshot, ShippingInfo)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testPreCtrlNotifyBackupShipped() throws InvalidNameException, DatabaseException {
        ...
        // Act
        backupShippingS3Service.preCtrlNotifyBackupShipped(true, true, snap, new ShippingInfo());
    }

    /**
     * Test {@link BackupShippingS3Service#postAllBackupPartsRegistered(Snapshot, ShippingInfo)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#postAllBackupPartsRegistered(Snapshot, ShippingInfo)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testPostAllBackupPartsRegistered() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: Exception in arrange section.
        //   Diffblue Cover was unable to construct an instance of the class under test using
        //   com.linbit.linstor.backupshipping.BackupShippingS3Service.postAllBackupPartsRegistered(Snapshot, ShippingInfo).
        ...
        BackupShippingS3Service backupShippingS3Service = null;
        Snapshot snapRef = null;
        ShippingInfo infoRef = null;

        // Act
        backupShippingS3Service.postAllBackupPartsRegistered(snapRef, infoRef);
    ...
    /**
     * Test {@link BackupShippingS3Service#BackupShippingS3Service(BackupToS3, ErrorReporter, ExtCmdFactory, ControllerPeerConnector, CtrlStltSerializer, AccessContext, StltSecurityObjects, StltConfigAccessor, StltConnTracker, RemoteMap, LockGuardFactory)}.
     * <p>
     * Method under test: {@link BackupShippingS3Service#BackupShippingS3Service(BackupToS3, ErrorReporter, ExtCmdFactory, ControllerPeerConnector, CtrlStltSerializer, AccessContext, StltSecurityObjects, StltConfigAccessor, StltConnTracker, RemoteMap, LockGuardFactory)}
     */
    @Test
    @Ignore("TODO: Complete this test")
    public void testNewBackupShippingS3Service() {
        // TODO: Diffblue Cover was only able to create a partial test for this method:
        //   Reason: No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        ...
        // Act
        new BackupShippingS3Service(backupHandlerRef, errorReporterRef, extCmdFactoryRef, controllerPeerConnectorRef,
                interComSerializerRef, null, stltSecObjRef, stltConfigAccessorRef2, null, null,
                new LockGuardFactory(reconfigurationLockRef2, nodesMapLockRef2, rscDfnMapLockRef2, storPoolDfnMapLockRef2,
                        ctrlConfigLockRef, kvsMapLockRef, rscGrpMapLockRef, extFileMapLockRef, remoteMapLockRef,
                        new ReentrantReadWriteLock(true)));
